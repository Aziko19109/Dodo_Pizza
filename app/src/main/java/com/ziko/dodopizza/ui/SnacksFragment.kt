...
import com.ziko.dodopizza.databinding.FragmentSnacksBinding
...
class SnacksFragment : Fragment() {
    ...
    fun takeLastId() {
        ...
        reference = firebaseDatabase.getReference("snacks")
    ...
    fun loadData() {
        ...
        for (i in 1..lastId) {
            reference = firebaseDatabase.getReference("snacks/$i")
